  ...
  return (
    <div ref={referenciaContentor} className={mesclarClasses("relative", className)}>
      <button
        ...
        className="flex items-center gap-1.5 rounded-botao border border-borda px-2 py-1.5 text-texto-secundario transition-colors hover:border-acento-soft hover:text-texto-primario"
      >
      ...
      <AnimatePresence>
        {aberto && (
          <motion.ul
            ...
            className="absolute right-0 top-full z-50 mt-2 w-44 rounded-quadro border border-borda bg-fundo-elevado py-1 shadow-suave"
          >
