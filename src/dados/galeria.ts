...
import cozinha1 from "../ativos/imagens/galeria/cozinha-1.jpg";
import sala1 from "../ativos/imagens/galeria/sala-1.jpg";
import fachada1 from "../ativos/imagens/galeria/fachada-1.jpg";
import quarto1 from "../ativos/imagens/galeria/quarto-1.jpg";
import externa1 from "../ativos/imagens/galeria/externa-1.jpg";
...
export const itensGaleria: ItemGaleria[] = [
  ...
  { id: "galeria-quarto-1", imagem: quarto1, categoria: "quartos" },
  {
    ...
    imagem: externa1,
    categoria: "areas-externas",
    destaqueVertical: true,
  },
